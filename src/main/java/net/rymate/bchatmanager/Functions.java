...
public class Functions {
	...
	this.displayNameFormat = plugin.getConfig().getString(
		"display-name-format", this.displayNameFormat);
    }
	...
	String worldName = player.getWorld().getName();
	player.setDisplayName(colorize(replacePlayerPlaceholders(player,
	...
	String output;
	output = ApiLayer.getValue(player.getWorld().getName(),
		CalculableType.USER, player.getName(), info);
